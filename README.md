...
- **Markdown vs cell for interpretation:** Interpretations that depend on numbers generated by the notebook are kept as code cells so the figures update on re-run; purely qualitative interpretations use markdown cells.
